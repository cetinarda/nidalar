...
type Tab = 'home' | 'library' | 'archive' | 'profile';

const TAB_CONFIG: { key: Tab; tKey: 'tab.home' | 'tab.library' | 'tab.archive' | 'tab.profile'; symbol: string; activeColor: string }[] = [
  { key: 'home',    tKey: 'tab.home',    symbol: '✦', activeColor: Colors.tabHome },
  { key: 'library', tKey: 'tab.library', symbol: '◈', activeColor: Colors.tabLibrary },
  { key: 'archive', tKey: 'tab.archive', symbol: '◇', activeColor: Colors.tabArchive },
  { key: 'profile', tKey: 'tab.profile', symbol: '⊙', activeColor: Colors.tabProfile },
];
